...
const dictionaries: Record<Locale, Dict> = {
  en: {
    ...
    table_pdf: "Table PDF",
    ai_tutor: "AI Tutor",
    ask_ai_placeholder: "Ask about this question (method, formula, next step)...",
    send: "Send",
    thinking: "Thinking...",
    ai_error:
      "AI tutor is unavailable. Start with OPENAI_API_KEY in local/server mode.",
  ...
  sv: {
    ...
    ai_tutor: "AI-handledare",
    ask_ai_placeholder: "Fråga om uppgiften (metod, formel, nästa steg)...",
    send: "Skicka",
    thinking: "Tänker...",
    ai_error:
      "AI-modulen är inte tillgänglig. Starta med OPENAI_API_KEY i lokal/server-läge.",
  ...
  fr: {
    ...
    ai_tutor: "Tuteur IA",
    ask_ai_placeholder:
      "Posez une question sur cet exercice (méthode, formule, étape suivante)...",
    send: "Envoyer",
    thinking: "Réflexion...",
    ai_error:
      "Le module IA est indisponible. Lancez en mode local/serveur avec OPENAI_API_KEY.",
